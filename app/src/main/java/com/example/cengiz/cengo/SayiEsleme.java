...
public class SayiEsleme extends Activity implements View.OnDragListener, OnTouchListener
{
    MediaPlayer bg;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_sayiesleme);
    ...
    public boolean onTouch(View v, MotionEvent event)
    {
        ...
        switch (event.getAction())
        {
            case MotionEvent.ACTION_DOWN:
                ...
                {
                    dropView.setImageResource(R.drawable.bir);
    ...
    public boolean onDrag(View v, DragEvent event)
    {
        ...
        switch (action)
        {
            ...
            case DragEvent.ACTION_DROP:
                ...
                Toast.makeText(SayiEsleme.this, "Resim yerleşti " + tag, Toast.LENGTH_SHORT).show();
            ...
            case DragEvent.ACTION_DRAG_ENDED:
                ...
                if (event.getResult())
                {
                    Toast.makeText(SayiEsleme.this, "Doğru !", Toast.LENGTH_SHORT).show();

                }
                else
                {
                    Toast.makeText(SayiEsleme.this, "Olmadı tekrar dene !", Toast.LENGTH_SHORT).show();
