...
import static com.example.cengiz.cengo.R.id.eslestir;

public class eslesayi2 extends AppCompatActivity{
    ...
    protected  void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.eslesayi2);
        dragbutton = (ImageView) findViewById(R.id.ikki);
    ...
    public void sonraki_sayfa(View view) {
        ...
        Intent intent = new Intent(this, eslesayi3.class);
