...
public class eslesayi5 extends AppCompatActivity{
    ...
    protected  void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.eslesayi5);
        dragbutton = (ImageView) findViewById(R.id.bes);
    ...
    public void sonraki_sayfa(View view) {
        ...
        Intent intent = new Intent(this, eslesayi6.class);
