...
public class eslesayi7 extends AppCompatActivity{
    ...
    protected  void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.eslesayi7);
        dragbutton = (ImageView) findViewById(R.id.yedi);
    ...
    public void sonraki_sayfa(View view) {
        ...
        Intent intent = new Intent(this, eslesayi8.class);
