...
public class eslesayi8 extends AppCompatActivity{
    ...
    protected  void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.eslesayi8);
        dragbutton = (ImageView) findViewById(R.id.sekiz);
    ...
    public void sonraki_sayfa(View view) {
        ...
        Intent intent = new Intent(this, eslesayi9.class);
