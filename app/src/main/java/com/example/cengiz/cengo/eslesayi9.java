...
public class eslesayi9 extends AppCompatActivity{
    ...
    protected  void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.eslesayi9);
        dragbutton = (ImageView) findViewById(R.id.dokuz);
    ...
    public void sonraki_sayfa(View view) {
        ...
        Intent intent = new Intent(this, eslesayi10.class);
